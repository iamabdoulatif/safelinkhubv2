...
// Primary go-to-market countries, in priority order — Afrique de l'Ouest,
// puis Afrique centrale, puis Nigeria/Kenya. These appear first in every
// selector so the overwhelming majority of signups don't have to scroll.
const PRIMARY_MARKET_COUNTRIES: Country[] = [
  ...
  { name: "République Démocratique du Congo", iso2: "CD", dialCode: "+243" },
