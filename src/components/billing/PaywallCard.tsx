...
export default function PaywallCard({
  ...
  return (
    <div className="animate-fade-slide-up overflow-hidden rounded-xl border border-warn bg-clay p-5">
      <div className="flex items-center gap-3">
        <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-clay text-warn">
      ...
      <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
        <div className="rounded-lg bg-paper px-3 py-2.5 ring-1 ring-line-soft">
          <p className="text-xs text-ink-soft">Frais unique</p>
          <p className="mt-0.5 font-semibold text-ink">{fcfa(feeCents)}</p>
        </div>
        <div className="rounded-lg bg-paper px-3 py-2.5 ring-1 ring-line-soft">
      ...
      {sufficientBalance ? (
        <p className="mt-4 flex items-center gap-1.5 rounded-lg bg-clay px-3 py-2.5 text-xs font-medium text-ok">
