...
export async function GET(
  ...
  // the freshly-installed tunnel. The OpenVPN handshake on the router side
  // can take a few seconds after the script runs, so a failed check here
  // just leaves the router "installing" — the setup page keeps polling
  // checkRouterConnection until syncRouterStats succeeds.
