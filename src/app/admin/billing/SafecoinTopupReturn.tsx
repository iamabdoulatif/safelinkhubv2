...
export default function SafecoinTopupReturn({ transactionId }: { transactionId: string }) {
  ...
  if (phase === "completed") {
    return (
      <div className="mb-4 flex items-center gap-2 rounded-lg border border-ok bg-ok-soft px-3 py-2.5 text-sm text-ok">
  ...
  if (phase === "failed") {
    return (
      <div className="mb-4 flex items-center gap-2 rounded-lg border border-err bg-err-soft px-3 py-2.5 text-sm text-err">
  ...
  return (
    <div className="mb-4 flex items-center gap-2 rounded-lg border border-line-soft bg-clay px-3 py-2.5 text-sm text-ink-soft">
