      ...
      <div className="mt-5 grid gap-5 xl:grid-cols-[1.04fr_0.96fr]">
        <section className="border-2 border-line bg-paper p-5">
          ...
          <form action={groupAction} className="mt-5 border-t border-line-soft pt-5">
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2"><label className={labelClass}>Nom<input name="name" required placeholder="Togo roaming" className={inputClass} /></label><label className={labelClass}>Code <span className="normal-case tracking-normal">(optionnel)</span><input name="code" placeholder="TOGO-ROAMING" className={inputClass} /></label></div>
