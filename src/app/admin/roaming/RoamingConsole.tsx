    ...
    <div className="animate-fade-in-up pb-10">
      ...
      {activeView === "groups" && (
        <section className={`mt-5 ${panelClass}`}>
          ...
          {confirmingGroupId && <p className="mt-3 border-l border-red-600 bg-red-50 px-3 py-2 text-xs leading-5 text-red-800">La suppression retire la structure et ses offres du SaaS, sans effacer les profils des MikroTik. Elle est refusée tant qu’un compte nominatif est encore rattaché à ce groupe.</p>}
