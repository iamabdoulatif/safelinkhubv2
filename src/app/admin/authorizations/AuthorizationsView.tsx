    ...
    <div className="flex flex-col items-end gap-1">
      <div className="flex items-center gap-1.5">
        <button
          ...
          disabled={pending}
          className="inline-flex items-center gap-1 rounded-lg bg-ok px-2.5 py-1.5 text-xs font-medium text-white hover:bg-ink disabled:opacity-60"
        >
        ...
        <button
          ...
          disabled={pending}
          className="inline-flex items-center gap-1 rounded-lg border border-err px-2.5 py-1.5 text-xs font-medium text-err hover:bg-err-soft disabled:opacity-60"
        >
    ...
    <div className="rounded-xl border border-line-soft bg-paper p-4 shadow-sm">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            <p className="font-semibold text-ink">{row.requesterName}</p>
            <span className="rounded-full bg-clay px-2 py-0.5 text-xs font-medium text-ink">
          ...
          <p className="truncate text-sm text-ink-soft">{row.requesterEmail}</p>
          {row.note && (
            <p className="mt-2 rounded-lg bg-clay/50 px-3 py-2 text-sm text-ink">“{row.note}”</p>
          )}
...
export default function AuthorizationsView({
  ...
  return (
    <div className="animate-fade-in-up">
      <h1 className="text-ink text-2xl font-semibold tracking-tight">Demandes d&apos;autorisation</h1>
...
function TabButton({
  ...
  return (
    ...
    >
      {label}
      {count > 0 && (
        <span className="rounded-full bg-warn-soft px-1.5 py-0.5 text-xs font-semibold text-warn">
          {count}
        </span>
      )}
    </button>
