    ...
    <section className="border border-line bg-paper p-4 sm:p-6 rounded-xl">
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3">
        <button
          ...
          className="border border-line bg-brand px-4 py-2 text-sm font-semibold text-slate-deep transition-colors duration-150 hover:brightness-95 disabled:cursor-not-allowed disabled:opacity-50 rounded-full"
        >
