    ...
    <div className="rounded-xl border border-err bg-err-soft/40 p-6">
      ...
      {!confirming ? (
        <button
          ...
          className="mt-4 rounded-lg border border-err bg-paper px-4 py-2 text-sm font-medium text-err hover:bg-err-soft"
        >
        ...
        <form action={formAction} className="mt-4 space-y-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="rounded-lg border border-line-soft bg-paper px-4 py-2 text-sm font-medium text-ink-soft hover:bg-clay"
            >
              Annuler
            </button>
            <button
