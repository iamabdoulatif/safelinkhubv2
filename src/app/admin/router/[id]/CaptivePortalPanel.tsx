          ...
          {data.templates.length === 0 ? (
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                onClick={install}
                className="inline-flex items-center gap-2 border border-line bg-brand px-4 py-2 text-sm font-semibold text-slate-deep transition-colors duration-150 hover:bg-brand/80 disabled:opacity-60 rounded-full"
              >
                {pending ? (
