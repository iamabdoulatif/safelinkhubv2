  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="flex items-center gap-2 rounded-lg border border-line-soft bg-paper px-3 py-1.5 text-sm font-medium text-ink-soft hover:bg-clay disabled:opacity-60"
      >
