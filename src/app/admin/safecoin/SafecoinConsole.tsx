  ...
  return (
    <div className="animate-fade-in-up space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div><p className="text-xs font-bold uppercase tracking-[0.22em] text-brand-deep">SafeLinkHub · superadmin</p><h1 className="mt-1 text-ink text-2xl font-semibold tracking-tight">Station de contrôle</h1><p className="mt-1 text-sm text-ink-soft">Safecoin, émission, consommation et promotions de la plateforme.</p></div>
