...
export default function SafecoinActions({
  ...
  return (
    <div className="border-2 border-line bg-paper p-5 sm:p-6">
      ...
      <form action={action} className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <label className="text-sm font-medium text-ink">FCFA pour 1 SC<input name="rateFcfaPerSc" type="number" min={1} required defaultValue={rateFcfaPerSc} className="mt-1.5 w-full border border-line-soft bg-paper px-3 py-2.5 text-sm" /></label>
        <label className="text-sm font-medium text-ink">Frais recharge (centièmes SC)<input name="rechargeFeeScCents" type="number" min={0} required defaultValue={rechargeFeeScCents} className="mt-1.5 w-full border border-line-soft bg-paper px-3 py-2.5 text-sm" /></label>
        <label className="text-sm font-medium text-ink">Frais VPN (centièmes SC)<input name="vpnFeeScCents" type="number" min={0} required defaultValue={vpnFeeScCents} className="mt-1.5 w-full border border-line-soft bg-paper px-3 py-2.5 text-sm" /></label>
        <label className="text-sm font-medium text-ink">Frais Auto-Setup (centièmes SC)<input name="autoSetupFeeScCents" type="number" min={0} required defaultValue={autoSetupFeeScCents} className="mt-1.5 w-full border border-line-soft bg-paper px-3 py-2.5 text-sm" /></label>
