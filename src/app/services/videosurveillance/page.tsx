...
export const metadata: Metadata = {
  title: "Caméra de surveillance | SafeLinkHub",
  description: "Offre en préparation — décrivez-nous votre besoin.",
};

export async function CameraPageContent({ locale }: { locale: Locale }) {
  const dict = await getDictionary(locale);
  const t = dict.servicePages.camera;
  return (
    <ServicePageShell
      dict={dict}
      locale={locale}
...
export default function CameraPage() {
  return <CameraPageContent locale="fr" />;
}
